...
{		
	...
	{		
		...
		_tileBrain.tileHightligh.x = Math.floor(_brain.flixelPointer.x / _tileBrain.tileHightligh.width) * _tileBrain.tileHightligh.width;
		_tileBrain.tileHightligh.y = Math.floor(_brain.flixelPointer.y / _tileBrain.tileHightligh.height) * _tileBrain.tileHightligh.height;
